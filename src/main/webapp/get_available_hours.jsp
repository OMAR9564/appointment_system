...
<%
    ...
    String query1 = "SELECT hour FROM appointments WHERE = '"+selectedOption+"'";
    ArrayList<GetInfo> dateHours = conSql.readHourData(query1);
    ...
    for (int i = 0; i < availableHours.size(); i++) {
        ...
        dateHour = dateHours.get(i).getAppHour();
