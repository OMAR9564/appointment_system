...
<%--<%@page import="com.omar.hotelreservation.tags"%>--%>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="kontrolPaneli" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="profilim">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="adminSqlCon?page=girisYap&iam=logout">
