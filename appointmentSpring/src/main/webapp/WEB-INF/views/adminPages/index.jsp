...
<%
    ...
    if (clientIP == null || !(clientIP.equals(ip)) ||
        ...
        response.sendRedirect("/girisYap");
    } else {
    ...
    HttpSession urlSession = (HttpSession) request.getSession();
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="kontrolPaneli">Ana Sayfa</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="adminSqlCon" id="editForm">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <input type="text" value="/kontrolPaneli" name="page" hidden>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="post" action="adminSqlCon">
                                                    <input type="text" class="delIdInput" name="id" id="id" hidden>
                                                    <input type="text" value="/kontrolPaneli" name="page"
                                                           hidden>
                        ...
                        <div class="row d-flex justify-content-evenly">
                            ...
                            <div class="col mt-4">
                                <a href="tumRandevular?filter=receivedToday">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" value="tumRandevular" name="page"
                                                   hidden>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6 ms-auto">
                                                ...
                                                <div class="hours">
                                                    ...
                                                    <form method="post" onsubmit="return validateForm()" action="/take_appoint" id="form">
                                                        ...
                                                        <input type="hidden" id="page-name" name="page-name" value="/kontrolPaneli">
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function (event) {
        ...
        var url = "/get_available_hours" + "?selectedDate=" + encodeURIComponent(selectedFilter) + "&selectedOption=" + encodeURIComponent(selectedOption) + "&selectedDoktor=" + encodeURIComponent(selectDoctor);
    ...
    function getHours(){
        ...
        var xhttp = new XMLHttpRequest();
        var url = "/get_available_hours" + "?selectedDate=" + encodeURIComponent(selectedFilter) + "&selectedOption=" + encodeURIComponent(selectedOption) + "&selectedDoktor=" + encodeURIComponent(selectedDoctor);
        xhttp.open("GET", url, true);
        xhttp.send();
