...
<%
    ...
    if (pageName.equals("kontrolPaneli") || pageName.equals("tumRandevular")) {
                ...
                if (userInfo.size() > 0) {
                    ...
                    if (depass.equals(password)){
                        ...
                        if (remember != null) {
                            ...
                            response.sendRedirect("kontrolPaneli" + "?message=" + URLEncoder.encode(appointmentMade) + "&dic=" + URLEncoder.encode(dic, "UTF-8"));
                    ...
                    //sifre yanlis
                        ...
                        response.sendRedirect(pageName + "?message=" + URLEncoder.encode(appointmentMade) + "&dic=" + URLEncoder.encode(dic, "UTF-8"));
        ...
        try {
            ...
            if (iam.equals("profilEdit")) {
                ...
                try{
                    ...
                    appointmentMade = "true";
                    response.sendRedirect("girisYap" + "?message=" + URLEncoder.encode(appointmentMade) + "&dic=" + URLEncoder.encode(messageOk));
        ...
        appointmentMade = "false";
        response.sendRedirect("kontrolPaneli" + "?message=" + URLEncoder.encode(appointmentMade) + "&dic=" + URLEncoder.encode(messageOk));
    }
