...
window.addEventListener("load", function () {
  ...
  var url = "admin_get_available_hours" + "?filter=" + encodeURIComponent(selectedFilter) + "&selectedOption=" + encodeURIComponent(selectedOption) + "&selectedDoktor=" + encodeURIComponent(selectDoctor);
